            ...
            if (!existingProducts.Any())
            {
                ...
                var products = new List<Product>
                {
                    ...
                    new Product
                    {
                        ...
                        MinStock = 10,
                        SKU = "SAMS-S23-128",
                        MainImage = "https://via.placeholder.com/400x400/3B82F6/FFFFFF?text=Galaxy+S23",
                        Images = new List<string> { "https://via.placeholder.com/400x400/3B82F6/FFFFFF?text=Galaxy+S23-1", "https://via.placeholder.com/400x400/3B82F6/FFFFFF?text=Galaxy+S23-2" },
                    ...
                    new Product
                    {
                        ...
                        MinStock = 5,
                        SKU = "DELL-XPS13-16GB",
                        MainImage = "https://via.placeholder.com/400x400/3B82F6/FFFFFF?text=Dell+XPS+13",
                        Images = new List<string> { "https://via.placeholder.com/400x400/3B82F6/FFFFFF?text=Dell+XPS+13-1", "https://via.placeholder.com/400x400/3B82F6/FFFFFF?text=Dell+XPS+13-2" },
                        CategoryId = categories.First(c => c.Name == "Electrónicos").Id,
                        Brand = "Dell",
                        IsFeatured = true,
                        Weight = 1.2m,
                    ...
                    new Product
                    {
                        ...
                        MinStock = 3,
                        SKU = "SONY-PS5-DISC",
                        MainImage = "https://via.placeholder.com/400x400/8B5CF6/FFFFFF?text=PS5",
                        Images = new List<string> { "https://via.placeholder.com/400x400/8B5CF6/FFFFFF?text=PS5-1", "https://via.placeholder.com/400x400/8B5CF6/FFFFFF?text=PS5-2" },
                    ...
                    new Product
                    {
                        ...
                        MinStock = 8,
                        SKU = "NINT-SW-OLED",
                        MainImage = "https://via.placeholder.com/400x400/8B5CF6/FFFFFF?text=Switch+OLED",
                        Images = new List<string> { "https://via.placeholder.com/400x400/8B5CF6/FFFFFF?text=Switch+OLED-1" },
                        CategoryId = categories.First(c => c.Name == "Gaming").Id,
                        Brand = "Nintendo",
                        IsFeatured = false,
                        Weight = 0.42m,
                    ...
                    new Product
                    {
                        ...
                        MinStock = 20,
                        SKU = "NIKE-DRIFIT-M",
                        MainImage = "https://via.placeholder.com/400x400/EC4899/FFFFFF?text=Nike+Dri-FIT",
                        Images = new List<string> { "https://via.placeholder.com/400x400/EC4899/FFFFFF?text=Nike+Dri-FIT-1" },
                    ...
                    new Product
                    {
                        ...
                        MinStock = 15,
                        SKU = "LEVI-501-32",
                        MainImage = "https://via.placeholder.com/400x400/EC4899/FFFFFF?text=Levis+501",
                        Images = new List<string> { "https://via.placeholder.com/400x400/EC4899/FFFFFF?text=Levis+501-1", "https://via.placeholder.com/400x400/EC4899/FFFFFF?text=Levis+501-2" },
                        CategoryId = categories.First(c => c.Name == "Ropa").Id,
                        Brand = "Levi's",
                        IsFeatured = false,
                        Weight = 0.5m,
                    ...
                    new Product
                    {
                        ...
                        MinStock = 8,
                        SKU = "NESP-VERTUO-BLK",
                        MainImage = "https://via.placeholder.com/400x400/10B981/FFFFFF?text=Nespresso+Vertuo",
                        Images = new List<string> { "https://via.placeholder.com/400x400/10B981/FFFFFF?text=Nespresso+Vertuo-1" },
                    ...
                    new Product
                    {
                        ...
                        MinStock = 12,
                        SKU = "LAMP-LED-DESK",
                        MainImage = "https://via.placeholder.com/400x400/10B981/FFFFFF?text=Lampara+LED",
                        Images = new List<string> { "https://via.placeholder.com/400x400/10B981/FFFFFF?text=Lampara+LED-1" },
                        CategoryId = categories.First(c => c.Name == "Hogar").Id,
                        Brand = "IKEA",
                        IsFeatured = false,
                        Weight = 0.8m,
                    ...
                    new Product
                    {
                        ...
                        MinStock = 10,
                        SKU = "ADID-FBALL-5",
                        MainImage = "https://via.placeholder.com/400x400/F59E0B/FFFFFF?text=Pelota+Adidas",
                        Images = new List<string> { "https://via.placeholder.com/400x400/F59E0B/FFFFFF?text=Pelota+Adidas-1" },
                    ...
                    new Product
                    {
                        ...
                        MinStock = 5,
                        SKU = "WILS-TENNIS-PRO",
                        MainImage = "https://via.placeholder.com/400x400/F59E0B/FFFFFF?text=Raqueta+Wilson",
                        Images = new List<string> { "https://via.placeholder.com/400x400/F59E0B/FFFFFF?text=Raqueta+Wilson-1" },
                        CategoryId = categories.First(c => c.Name == "Deportes").Id,
                        Brand = "Wilson",
                        IsFeatured = false,
                        Weight = 0.31m,
                    ...
                    new Product
                    {
                        ...
                        MinStock = 15,
                        SKU = "TOLK-LOTR-TRI",
                        MainImage = "https://via.placeholder.com/400x400/EF4444/FFFFFF?text=El+Señor+de+los+Anillos",
                        Images = new List<string> { "https://via.placeholder.com/400x400/EF4444/FFFFFF?text=El+Señor+de+los+Anillos-1" },
                    ...
                    new Product
                    {
                        ...
                        MinStock = 25,
                        SKU = "MART-CLEAN-CODE",
                        MainImage = "https://via.placeholder.com/400x400/EF4444/FFFFFF?text=Clean+Code",
                        Images = new List<string> { "https://via.placeholder.com/400x400/EF4444/FFFFFF?text=Clean+Code-1" },
                        CategoryId = categories.First(c => c.Name == "Libros").Id,
                        Brand = "Prentice Hall",
                        IsFeatured = false,
                        Weight = 0.8m,
